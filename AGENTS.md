...
**`DATABASE_URL`:** use a URL fornecida pelo Supabase Connect. Em redes sem IPv6, use Session pooler (porta 5432); a conexão direta depende de IPv6. O cliente usa `prepare: false`.
